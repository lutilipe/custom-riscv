...
vcom -93 -work work {D:/custom-riscv/tb_unidade_de_controle_ciclo_unico.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L maxv -L rtl_work -L work -voptargs="+acc"  tb_unidade_de_controle_ciclo_unico
